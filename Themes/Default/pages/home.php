                ...
                <div class="bg-white rounded-lg shadow-md ">
                    <form action="/" method="get" class="p-3">
                        <input type="search" name="search"
                            class="block w-full bg-gray-200 text-gray-700  rounded-md px-4 py-2"
                            placeholder="Search Blogs">
                    </form>
                </div>
                <div class="pb-3 shadow-lg">
                    <h2 class="text-2xl font-inter text-gray-800 bg-green-400 py-2 px-4 rounded-lg">About Us</h2>
                    <p class="p-3 bg-white shadow rounded-lg text-gray-700 leading-relaxed">
                        <?= $website_description ?>
                    </p>
                </div>
                <div class="bg-white rounded-lg shadow-lg">
                    ...
                    <div class="p-3">
                        <form action="/newsletter-signup" method="post">
                            <input type="email" class="block w-full bg-gray-200 text-gray-700 rounded-md px-4 py-2 mb-4"
                                placeholder="Your Email">
                            <button type="submit"
                                class="bg-green-500 hover:bg-green-400 text-white font-bold py-2 px-4 rounded-full">Sign
                                Up</button>
                        </form>
                    </div>
                </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                <a href="#" class="block relative h-48 rounded overflow-hidden">
                    <img alt="category image" class="object-cover object-center w-full h-full block"
                        src="https://images.unsplash.com/photo-1552820728-8b83bb6b773f?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&w=1000&q=80">
                </a>
                <div class="p-4">
                    <h3 class="font-bold text-xl mb-2">Gaming</h3>
                    <p class="text-gray-700 text-base">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
            ...
            <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                <a href="#" class="block relative h-48 rounded overflow-hidden">
                    <img alt="category image" class="object-cover object-center w-full h-full block"
                        src="https://th.bing.com/th/id/OIP.5tMUlY_rhhM2EULUO4IS1wHaHa?pid=ImgDet&rs=1">
                </a>
                <div class="p-4">
                    <h3 class="font-bold text-xl mb-2">Anime</h3>
                    <p class="text-gray-700 text-base">Ut enim ad minim veniam, quis nostrud exercitation ullamco
            ...
            <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                <a href="#" class="block relative h-48 rounded overflow-hidden">
                    <img alt="category image" class="object-cover object-center w-full h-full block"
                        src="https://th.bing.com/th/id/OIP.lV8M5Hepc1AYlF362If9kwHaFj?pid=ImgDet&rs=1">
                </a>
                <div class="p-4">
                    <h3 class="font-bold text-xl mb-2">Travelling</h3>
                    <p class="text-gray-700 text-base">Duis aute irure dolor in reprehenderit in voluptate velit esse
            ...
            <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                ...
                <div class="p-4">
                    ...
                    <p class="text-gray-700 text-base">Excepteur sint occaecat cupidatat non proident, sunt in culpa qui
