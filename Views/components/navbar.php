...
<nav class="bg-white shadow-lg">
        ...
        <div class="flex justify-between">
            <div class="flex space-x-7">
                ...
                <div class="hidden md:flex items-center space-x-1">
                    ...
                    <a href="/authors"
                        class="py-4 px-2 text-gray-500 font-semibold hover:text-green-500 transition duration-300">Authors</a>
                    <a href="/contact"
    ...
    <div class="hidden mobile-menu">
        <ul class="">
            ...
            <li><a href="/authors"
                    class="block text-sm px-2 py-4 hover:bg-green-500 transition duration-300">Authors</a></li>
